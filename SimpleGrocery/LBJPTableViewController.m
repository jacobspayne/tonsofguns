...
{
    [super viewDidLoad];
    // Loads and parses a file named data.json bundled with my project.
    
    #warning bring in data from parse.com and put it in tableData
    ...
    // self.tableData = [jsonObject objectForKey:@"data"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[self.tableData objectAtIndex:indexPath.row] objectAtIndex:0];
    cell.detailTextLabel.text = [[self.tableData objectAtIndex:indexPath.row] objectAtIndex:1];
